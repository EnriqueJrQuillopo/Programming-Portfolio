...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <?php if($fetch_product['quantity']==0){ 
            $nostocks = $nostocks + 1;?>
         <input type="submit" class="btn" value="OUT OF STOCK" name="update_cart" disabled>
      <?php }else{
      ?>
   ...
   <div class="cart-total">
      ...
      <div class="flex">
         ...
         <?php if($nostocks>0){ ?>
            <input type="button" class="btn" value="<?php echo strval($nostocks),' Item/s are out of stock';?> " name="update_cart" disabled>
         <?php } else{
         ?>
